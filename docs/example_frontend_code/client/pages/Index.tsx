...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-[420px] h-[326px] mb-8 overflow-hidden">
        <div className="absolute left-1/2 -translate-x-1/2 w-[253px] h-[326px] bg-vibe-gray-200 rounded shadow-lg z-10 flex items-center justify-center">
          <p className="text-center text-xs px-4">Visuals of other<br />cyber pets</p>
        </div>
        <div className="absolute left-0 top-0 w-[96px] h-[326px] bg-vibe-gray-200 rounded shadow-lg flex items-center justify-center">
          <p className="text-center text-xs px-2">Visuals of other<br />cyber pets</p>
        </div>
        <div className="absolute right-0 top-0 w-[96px] h-[326px] bg-vibe-gray-200 rounded shadow-lg flex items-center justify-center">
          <p className="text-center text-xs px-2">Visuals of other<br />cyber pets</p>
        </div>
      </div>
